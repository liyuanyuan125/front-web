    ...
    <i-col span="24" class="demo-tabs-style2">
      <Tabs type="card" :animated="false">
        ...
        <Tab-pane label="汇总" key="key1">
          <div class='imgs'>
            <img src="./assets/西贝/1-2.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放人群</div>
            <img src="./assets/西贝/1-3.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放场馆</div>
            <img src="./assets/西贝/1-4.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放地区</div>
            <img src="./assets/西贝/1-5.png" alt="">
          </div>
        </Tab-pane>
        <Tab-pane label="按人群" key="key2">
          <div class='imgs'>
            <img src="./assets/西贝/2-1.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>地域分布</div>
            <img src="./assets/西贝/2-2.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>人群画像</div>
            <img src="./assets/西贝/2-3.png" alt="">
          </div>
        </Tab-pane>
        <Tab-pane label="按场馆" key="key3">
          <div class='imgs'>
            <img src="./assets/西贝/3-1.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>成效概览</div>
            <img src="./assets/西贝/3-2.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>单个场馆成效</div>
            <img src="./assets/西贝/3-3.png" alt="">
          </div>
        </Tab-pane>
        <Tab-pane label="按地区" key="key4">
          <div class='imgs'>
            <img src="./assets/西贝/4-1.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放人群</div>
            <img src="./assets/西贝/4-2.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放场馆</div>
            <img src="./assets/西贝/4-3.png" alt="">
          </div>
          <div class='imgs'>
            <div class='ze'>投放地区</div>
            <img src="./assets/西贝/4-4.png" alt="">
          </div>
        </Tab-pane>
      </Tabs>
    </i-col>
