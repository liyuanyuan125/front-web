<template>
  <div>
    <Modal v-model="value.visible" title="确定接单影院" width="700">
      <Row type="flex" justify="space-between">
        <Col :span="6">
          <AreaSelect v-model="area" show-region :max-level="2" no-self/>
        </Col>
      ...
      <Table
        stripe :columns="columns" :data="data" @on-select="singleSelect"   @on-select-all="selectAll" ></Table>
      <Page
