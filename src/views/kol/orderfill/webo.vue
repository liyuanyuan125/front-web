    ...
    <div class="detail-box">
      <Form :model="form" ref="dataform" :rules="rule" label-position="left" :label-width="100" class="edit-input">
        <FormItem label="发布时间" prop="name">
          <DatePicker format="yyyy-MM-dd HH:mm" :options="startDate" v-model="form.publishTime" type="datetime" placeholder="请选择执行时间" style="width: 300px"></DatePicker>
        </FormItem>
        ...
        <FormItem label="原发内容" prop="summary">
          <Input v-model="form.summary" type="textarea" :autosize="{minRows: 4,maxRows: 10}" placeholder="请输入" />
        </FormItem>
