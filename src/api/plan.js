 ...
 * @param data
 */
export async function delCheckPlanList(query) {
 ...
 * @param data
 */
export async function relevanceVideo(data) {
 ...
 * @param data
 */
export async function queryRelevanceList(data) {
 ...
 * @param id
 */
export async function planDefault(id) {
 ...
 * @param data
 */
export async function cinemaList(data) {
 ...
 * @param id
 */
export async function subExamine(id) {
 ...
 * @param id
 */
export async function planPayment(id) {
 ...
 * @param id
 */
export async function planCancel(id) {
 ...
 */
export async function queryCinema(data) {
 ...
 * 数据报表-数据  mock数据
 */
export async function dateMockList(data) {
